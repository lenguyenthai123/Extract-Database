...
@Repository
@Qualifier("tableRepositoryOracleImpl")
public class TableRepositoryOracleImpl implements TableRepository {
    ...
    @Autowired
    public TableRepositoryOracleImpl(@Qualifier("triggerRepositoryOracleImpl") TriggerRepository triggerRepository) {
        ...
        try {
            ...
            try (ResultSet columnsResultSet = metaData.getColumns(databaseName, schemaName, tableName, "%")) {
                while (columnsResultSet.next()) {
                    ...
                    Column column = Column.builder().name(columnName).dataType(dataType).size(columnSize).isPrimaryKey(isPrimaryKey).build();
